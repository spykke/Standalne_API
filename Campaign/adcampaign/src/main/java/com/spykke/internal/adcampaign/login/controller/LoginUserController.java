...
import com.spykke.internal.adcampaign.login.service.SecurityService;
...
public class LoginUserController {
    ...
    public String registration(@ModelAttribute("userForm") LoginUser userForm, BindingResult bindingResult) {
